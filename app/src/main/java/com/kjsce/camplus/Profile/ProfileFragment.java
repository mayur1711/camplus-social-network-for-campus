...
/* ---------- SIMILAR TO COMMENTS FRAGMENT ---------- */
/* ---------- PROFILE FRAGMENT IS USED TO VIEW OWN PROFILE ---------- */

@RequiresApi(api = Build.VERSION_CODES.M)
public class ProfileFragment extends Fragment implements View.OnScrollChangeListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profileMenu = view.findViewById(R.id.profile_options);
    ...
    private void getProfileInfo() {
        ...
        ProfileInfoRequest profileInfoRequest = new ProfileInfoRequest(userId, responseListener, errorListener);
        requestQueue.add(profileInfoRequest);
    }
    ...
    private StringRequest getProfilePosts(int requestCount) {
        ...
        ProfilePostsRequest profilePostsRequest = new ProfilePostsRequest(userId, requestCount,
                responseListener, errorListener);

        return profilePostsRequest;
    ...
    class ProfilePostsRequest extends StringRequest {
    ...
    class ProfileInfoRequest extends StringRequest {
